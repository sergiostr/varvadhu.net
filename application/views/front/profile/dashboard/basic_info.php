    ...
    <div id="edit_basic_info" style="display: none;">
        ...
        <form id="form_basic_info" class="form-default" role="form">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="number" class="form-control no-resize" name="child_count" value="<?php echo $basic_info_data[0]['child_count']?>" min="0">
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <?php
                            $id = $get_member[0]->on_behalf; 
                            if($id == 1) $dd = "Self";
                            elseif($id == 2) $dd = "Daughter/Son";
                            elseif($id == 3) $dd = "Sister";
                            elseif($id == 4) $dd = "Brother";
                            elseif($id == 5) $dd = "Friend";
                            elseif($id == 6) $dd = "Mother";
                            else $dd = "Father";
                            echo $this->Crud_model->select_html('on_behalf', 'on_behalf', 'name', 'edit', 'form-control form-control-sm selectpicker present_on_behalf_edit', $get_member[0]->on_behalf, '', '', '');
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <?php
                            echo $this->Crud_model->select_html('caste', 'caste', 'name', 'edit', 'form-control form-control-sm selectpicker present_on_behalf_edit', $basic_info_data[0]['on_behalf'], '', '', '');
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="sub_caste" class="text-uppercase c-gray-light"><?php echo translate('Gotra')?></label>
                        <input type="text" class="form-control no-resize" name="sub_caste" value="<?php echo $get_member[0]->subcaste?>">
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="user_height" class="text-uppercase c-gray-light"><?php echo translate('height')?></label>
                        <?php
                            echo $this->Crud_model->select_html('user_height', 'user_height', 'name', 'edit', 'form-control form-control-sm selectpicker present_on_behalf_edit', $basic_info_data[0]['on_behalf'], '', '', '');
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <?php
                            echo $this->Crud_model->select_html('religion', 'religion', 'name', 'edit', 'form-control form-control-sm selectpicker present_on_behalf_edit', $basic_info_data[0]['on_behalf'], '', '', '');
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
