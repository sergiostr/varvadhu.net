    ...
    <div id="edit_family_info" style="display: none;">
        ...
        <form id="form_family_info" class="form-default" role="form">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="family_type" class="text-uppercase c-gray-light"><?php echo 'Family Type';?></label>
                        <?php
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="family_status" class="text-uppercase c-gray-light"><?php echo 'Family Status';?></label>
                        <?php
                            echo $this->Crud_model->select_new_html('family_status', 'family_status', 'display', 'edit', 'form-control form-control-sm selectpicker', $get_member[0]->family_status, '', '', '');
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="family_value" class="text-uppercase c-gray-light"><?php echo 'Family Values';?></label>
                        <?php
                            echo $this->Crud_model->select_new_html('family_value', 'family_value', 'display', 'edit', 'form-control form-control-sm selectpicker', $get_member[0]->family_values, '', '', '');
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="mother_tounge" class="text-uppercase c-gray-light"><?php echo 'Mother Tounge';?></label>
                        <?php
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="father_name" class="text-uppercase c-gray-light"><?php echo translate('father').' Name';?></label>
                        <input type="text" class="form-control no-resize" name="father_name" value="<?php echo $family_info_data[0]['father_name']?>">
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="mother_name" class="text-uppercase c-gray-light"><?php echo translate('mother').' Name';?></label>
                        <input type="text" class="form-control no-resize" name="mother_name" value="<?php echo $family_info_data[0]['mother_name']?>">
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="father_occupation" class="text-uppercase c-gray-light"><?php echo translate('father').' Occupation';?></label>
                        <input type="text" class="form-control no-resize" name="father_occupation" value="<?php echo $family_info_data[0]['father_occupation']?>">
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="mother_occupation" class="text-uppercase c-gray-light"><?php echo translate('mother').' Occupation';?></label>
                        <input type="text" class="form-control no-resize" name="mother_occupation" value="<?php echo $family_info_data[0]['mother_occupation']?>">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="brother_sister" class="text-uppercase c-gray-light"><?php echo "Married Brothers";?></label>
                        
                        <?php
                            echo $this->Crud_model->select_new_html('brothers-sister_count', 'married_brothers', 'display', 'edit', 'form-control form-control-sm selectpicker', $get_member[0]->married_brothers, '', '', '');
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="brother_sister" class="text-uppercase c-gray-light"><?php echo "Married Sisters";?></label>
                         <?php
                            echo $this->Crud_model->select_new_html('brothers-sister_count', 'married_sisters', 'display', 'edit', 'form-control form-control-sm selectpicker', $get_member[0]->married_sisters, '', '', '');
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
