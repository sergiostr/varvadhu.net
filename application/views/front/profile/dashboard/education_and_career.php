    ...
    <div id="edit_education_and_career" style="display: none;">
        ...
        <form id="form_education_and_career" class="form-default" role="form">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="education" class="text-uppercase c-gray-light"><?php echo translate('education')?></label> 
                        <?php
                            echo $this->Crud_model->select_html('education', 'education', 'name', 'edit', 'form-control form-control-sm selectpicker', $get_member[0]->eduction, '', '', '');
                        ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="education_detail" class="text-uppercase c-gray-light"><?php echo translate('educationdetail')?></label>
                        <input type="text" name="education_detail" id="education_detail"class="form-control no-resize" value="<?php echo $education_and_career_data[0]['education_detail']?>">
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="occupation_detail" class="text-uppercase c-gray-light"><?php echo translate('occupationdetail')?></label>
                        <input type="text" name="occupation_detail" id="occupation_detail" class="form-control no-resize" value="<?php echo $education_and_career_data[0]['occupation_detail']?>">
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="employed" class="text-uppercase c-gray-light"><?php echo translate('employed_in')?></label>
                        
                        <?php
                            echo $this->Crud_model->select_new_html('employed', 'employed', 'display', 'edit', 'form-control form-control-sm selectpicker', $get_member[0]->employed, '', '', '');
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
