   ...
   <body style="background: #000;">
      <div class="container" style="width: 80%;margin: 0 auto;padding: 20px;background: #fff;">
         <div class="d-flex flex-row-reverse">
            <button type="button" class="btn btn-success btn-sm btn-icon-only btn-shadow btnPrint p-2"  >Print & Download</button>
         </div>
         <div class="widget">
               ...
               <div class="card-body pt-2" style="padding: 1rem 0.5rem;">
                  ...
                  <div id="section_basic_info">
                     <div class="feature feature--boxed-border feature--bg-1 pt-3 pb-0 pl-3 pr-3 mb-3 border_top2x">
                        <div id="info_basic_info">
                           ...
                           ?>
									<div class="profile-picture" style="border:2px solid #e62e04; border-radius: 10px; height: 10vw; width: 10vw">
								  ...
								  <div class="table-full-width">
                                    ...
                                    ?>                            
										   ...
										   <tr>
                                                ...
                                                <td class="td-label">
                                                    <span><?php echo translate('Subcaste')?></span>
                                                </td>
                  ...
                  <div id="section_partner_expectation">
                     <div class="feature feature--boxed-border feature--bg-1 pt-3 pb-0 pl-3 pr-3 mb-3 border_top2x">
					  ...
					  <br>
					   <img src="<?php echo base_url() ?>/uploads/footer_logo/footer_logo_1595156340.png" class="img-responsive" style="float:right;">
                  </div>
