			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('marital_status', $basic_info[0]['marital_status'])?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $basic_info[0]['number_of_children']?>
								</td>
								<td>
									<b><?php echo translate('area')?></b>
								</td>
								<td>
									<?php echo $basic_info[0]['area']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									 <?php echo $this->Crud_model->get_type_name_by_id('on_behalf', $basic_info[0]['on_behalf']);?>
								</td>
							</tr>
							<tr>
								<td>
			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								...
								<td>
                            		<?php echo $this->Crud_model->get_type_name_by_id('country', $present_address[0]['country']);?>
								</td>
								<td>
									<b><?php echo translate('state')?></b>
								</td>
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('state', $present_address[0]['state']);?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('city', $present_address[0]['city']);?>
								</td>
								<td>
									<b><?php echo translate('postal-Code')?></b>
								</td>
								<td>
									<?php echo $present_address[0]['postal_code']?>
								</td>
							</tr>
							</table>
			            </div>
			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								...
								<td>
									<?php echo $education_and_career[0]['highest_education']?>
								</td>
								<td>
							...
							<tr>
								...
								<td>
									<?php echo $education_and_career[0]['annual_income']?>
								</td>
								<td>
									<b></b>
								</td>
			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								...
								<td>
									<?php echo $value->height.' '.translate('feet')?>
								</td>
								<td>
									<b><?php echo translate('weight')?></b>
								</td>
								<td>
									<?php echo $physical_attributes[0]['weight']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $physical_attributes[0]['eye_color']?>
								</td>
								<td>
									<b><?php echo translate('hair_color')?></b>
								</td>
								<td>
									<?php echo $physical_attributes[0]['hair_color']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $physical_attributes[0]['complexion']?>
								</td>
								<td>
									<b><?php echo translate('blood_group')?></b>
								</td>
								<td>
									<?php echo $physical_attributes[0]['blood_group']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $physical_attributes[0]['body_type']?>
								</td>
								<td>
									<b><?php echo translate('body_art')?></b>
								</td>
								<td>
									<?php echo $physical_attributes[0]['body_art']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $physical_attributes[0]['any_disability']?>
								</td>
								<td>
									<b></b>
								</td>
			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('language', $language[0]['language']);?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('language', $language[0]['speak']);?>
								</td>
								<td>
									<b><?php echo translate('read')?></b>
								</td>
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('language', $language[0]['read']);?>
								</td>
							</tr>
							</table>
			            </div>
			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								...
								<td>
									<?php echo $hobbies_and_interest[0]['hobby']?>
								</td>
								<td>
									<b><?php echo translate('interest')?></b>
								</td>
								<td>
									<?php echo $hobbies_and_interest[0]['interest']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $hobbies_and_interest[0]['music']?>
								</td>
								<td>
									<b><?php echo translate('books')?></b>
								</td>
								<td>
									<?php echo $hobbies_and_interest[0]['books']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $hobbies_and_interest[0]['movie']?>
								</td>
								<td>
									<b><?php echo translate('TV_show')?></b>
								</td>
								<td>
									<?php echo $hobbies_and_interest[0]['tv_show']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $hobbies_and_interest[0]['sports_show']?>
								</td>
								<td>
									<b><?php echo translate('fitness_activity')?></b>
								</td>
								<td>
									<?php echo $hobbies_and_interest[0]['fitness_activity']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $hobbies_and_interest[0]['cuisine']?>
								</td>
								<td>
									<b><?php echo translate('dress_style')?></b>
								</td>
								<td>
									<?php echo $hobbies_and_interest[0]['dress_style']?>
								</td>
							</tr>
							</table>
			            </div>
			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								...
								<td>
									<?php echo $personal_attitude_and_behavior[0]['affection']?>
								</td>
								<td>
									<b><?php echo translate('humor')?></b>
								</td>
								<td>
									<?php echo $personal_attitude_and_behavior[0]['humor']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $personal_attitude_and_behavior[0]['political_view']?>
								</td>
								<td>
									<b><?php echo translate('religious_service')?></b>
								</td>
								<td>
									<?php echo $personal_attitude_and_behavior[0]['religious_service']?>
								</td>
							</tr>
							</table>
			            </div>
			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('country', $residency_information[0]['birth_country']);?>
								</td>
								<td>
									<b><?php echo translate('residency_country')?></b>
								</td>
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('country', $residency_information[0]['residency_country']);?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('country', $residency_information[0]['citizenship_country']);?>
								</td>
								<td>
									<b><?php echo translate('grow_up_country')?></b>
								</td>
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('country', $residency_information[0]['grow_up_country']);?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $residency_information[0]['immigration_status']?>
								</td>
								<td>
									<b></b>
								</td>
			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('caste', $spiritual_and_social_background[0]['caste'], 'caste_name');?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('sub_caste', $spiritual_and_social_background[0]['sub_caste'], 'sub_caste_name');?>
								</td>
								<td>
									<b><?php echo translate('ethnicity')?></b>
								</td>
								<td>
									<?php echo $spiritual_and_social_background[0]['ethnicity']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $spiritual_and_social_background[0]['personal_value']?>
								</td>
								<td>
									<b><?php echo translate('family_value')?></b>
								</td>
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('family_value', $spiritual_and_social_background[0]['family_value']);?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $spiritual_and_social_background[0]['community_value']?>
								</td>
								<td>
									<b><?php echo translate('family_status')?></b>
								</td>
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('family_status', $spiritual_and_social_background[0]['family_status']);?>
								</td>
							</tr>
							<tr>
								<td>
			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								...
								<td>
									<?php echo $life_style[0]['diet']?>
								</td>
								<td>
									<b><?php echo translate('drink')?></b>
								</td>
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('decision', $life_style[0]['drink'])?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('decision', $life_style[0]['smoke'])?>
								</td>
								<td>
									<b><?php echo translate('living_with')?></b>
								</td>
								<td>
									<?php echo $life_style[0]['living_with']?>
								</td>
							</tr>
							</table>
			            </div>
			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								...
								<td>
									<?php echo $astronomic_information[0]['sun_sign']?>
								</td>
								<td>
									<b><?php echo translate('moon_sign')?></b>
								</td>
								<td>
									<?php echo $astronomic_information[0]['moon_sign']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $astronomic_information[0]['time_of_birth']?>
								</td>
								<td>
									<b><?php echo translate('city_of_birth')?></b>
								</td>
								<td>
									<?php echo $astronomic_information[0]['city_of_birth']?>
								</td>
							</tr>
							</table>
			            </div>
			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('country', $permanent_address[0]['permanent_country']);?>
								</td>
								<td>
									<b><?php echo translate('state')?></b>
								</td>
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('state', $permanent_address[0]['permanent_state']);?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('city', $permanent_address[0]['permanent_city']);?>
								</td>
								<td>
									<b><?php echo translate('postal-Code')?></b>
								</td>
								<td>
									<?php echo $permanent_address[0]['permanent_postal_code']?>
								</td>
							</tr>
							</table>
			            </div>
			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								...
								<td>
									<?php echo $family_info[0]['father']?>
								</td>
								<td>
									<b><?php echo translate('mother')?></b>
								</td>
								<td>
									<?php echo $family_info[0]['mother']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $family_info[0]['brother_sister']?>
								</td>
								<td>
									<b></b>
								</td>
			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								...
								<td>
									<?php echo $additional_personal_details[0]['home_district']?>
								</td>
								<td>
									<b><?php echo translate('family_residence')?></b>
								</td>
								<td>
									<?php echo $additional_personal_details[0]['family_residence']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $additional_personal_details[0]['fathers_occupation']?>
								</td>
								<td>
									<b><?php echo translate('special_circumstances')?></b>
								</td>
								<td>
									<?php echo $additional_personal_details[0]['special_circumstances']?>
								</td>
							</tr>
							</table>
			            </div>
			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								...
								<td>
									<?php echo $partner_expectation[0]['general_requirement']?>
								</td>
								<td>
									<b><?php echo translate('age')?></b>
								</td>
								<td>
									<?php echo $partner_expectation[0]['partner_age']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $partner_expectation[0]['partner_height']?>
								</td>
								<td>
									<b><?php echo translate('weight')?></b>
								</td>
								<td>
									<?php echo $partner_expectation[0]['partner_weight']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('marital_status', $partner_expectation[0]['partner_marital_status'])?>
								</td>
								<td>
									<b><?php echo translate('with_children_acceptables')?></b>
								</td>
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('decision', $partner_expectation[0]['with_children_acceptables'])?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('country', $partner_expectation[0]['partner_country_of_residence'])?>
								</td>
								<td>
									<b><?php echo translate('religion')?></b>
								</td>
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('religion', $partner_expectation[0]['partner_religion'])?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('sub_caste', $partner_expectation[0]['partner_sub_caste'], 'sub_caste_name');?>
								</td>
								<td>
									<b><?php echo translate('caste_/_sect')?></b>
								</td>
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('caste', $partner_expectation[0]['partner_caste'], 'caste_name');?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $partner_expectation[0]['partner_education']?>
								</td>
								<td>
									<b><?php echo translate('profession')?></b>
								</td>
								<td>
									<?php echo $partner_expectation[0]['partner_profession']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('decision', $partner_expectation[0]['partner_drinking_habits'])?>
								</td>
								<td>
									<b><?php echo translate('smoking_habits')?></b>
								</td>
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('decision', $partner_expectation[0]['partner_smoking_habits'])?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $partner_expectation[0]['partner_diet']?>
								</td>
								<td>
									<b><?php echo translate('body_type')?></b>
								</td>
								<td>
									<?php echo $partner_expectation[0]['partner_body_type']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $partner_expectation[0]['partner_personal_value']?>
								</td>
								<td>
									<b><?php echo translate('manglik')?></b>
								</td>
							...
							<tr>
								...
								<td>
									<?php echo $partner_expectation[0]['partner_any_disability']?>
								</td>
								<td>
									<b><?php echo translate('mother_tongue')?></b>
								</td>
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('language', $partner_expectation[0]['partner_mother_tongue'])?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $partner_expectation[0]['partner_family_value']?>
								</td>
								<td>
									<b><?php echo translate('prefered_country')?></b>
								</td>
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('country', $partner_expectation[0]['prefered_country'])?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $this->Crud_model->get_type_name_by_id('state', $partner_expectation[0]['prefered_state']);?>
								</td>
								<td>
									<b><?php echo translate('prefered_status')?></b>
								</td>
								<td>
									<?php echo $partner_expectation[0]['prefered_status']?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $partner_expectation[0]['partner_complexion']?>
								</td>
								<td>
									<b></b>
								</td>
